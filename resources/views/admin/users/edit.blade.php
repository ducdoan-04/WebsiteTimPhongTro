...
<div class="content-wrapper">
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			...
			<h4><a href="/admin" style="color:#000;"><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</a></span> - Trang Chỉnh sửa thông tin thành viên</h4>
			</div>
