        ...
        <div class="info info-user">
          <div class="contactpanel">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="padding-bottom: 0px;">
                   <center><p style="text-transform: uppercase;font-weight:bold;color: #0d85b8; font-size:20px;"><i class="fas fa-edit"></i>Chỉnh sửa bài đăng</p></center>
                </div>
          ...
          @if(Auth::user()->tinhtrang != 0)
					<form action="{{ route ('user.dangtin') }}" method="POST" enctype="multipart/form-data" >
                        <input type="hidden" name="MotelEdit_id" value="{{ $motelroom ->id }}">
            ...
            <div class="row">
              ...
              <div class="col-md-4"  >
                <div class="form-group">
                  ...
                  <input type="text" name="txtphone" class="form-control" placeholder="0919261712"  value="{{ $motelroom->phone}}">
                </div>
              </div>
            </div> 
            <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <label for="comment" style="top:10px; ">Mô tả ngắn</label>
                    <div>
                        <textarea class="form-control" id="content" rows="5" name="txtdescription" style="resize: none;" placeholder="Mô tả rõ thêm các thông tin khác.">{{ $motelroom->description}}</textarea>
                    </div>
                    <script>
                      ClassicEditor
