...
?>
	...
	<div class="container" style="min-height: 400px; margin-top:50px;">
		...
		<?php $firstDistrict = $listmotel[0]->district; ?>
			<h3 class="title-comm"><span class="title-holder" style="text-transform: uppercase;">KẾT QUẢ TÌM KIẾM CHO {{$keywordss}} ({{ count($listmotel) }})</span></h3>
		@else
		<h3 class="title-comm"><span class="title-holder" style="text-transform: uppercase;">KẾT QUẢ TÌM KIẾM CHO {{$keywordss}} (<?php echo count($listmotel); ?>)</span></h3>
		@endif
